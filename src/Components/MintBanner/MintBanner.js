...
function MintBanner() {
  ...
  const [CONFIG, SET_CONFIG] = useState({
    CONTRACT_ADDRESS: "0x9116534729c838b76cfd2c38ab60db081b372c5e",
    SCAN_LINK:
      "https://etherscan.io/address/0x9116534729c838b76cfd2c38ab60db081b372c5e",
    NETWORK: {
      NAME: "Ethereum",
      SYMBOL: "Eth",
      ID: 1,
    ...
    MARKETPLACE_LINK: "https://opensea.io/collection/yesbear",
    SHOW_BACKGROUND: false,
    DEEPLINK: "https://metamask.app.link/dapp/yesbear.xyz/",
  });
              ...
              <div className="mintBannerSingleItem">
                  ...
                  <div className="col-md-10">
                    <p>
                      ...
                      <span className="paraGraph">
                        {" "}
                        Over 10,000 investors have registered for only 6,466 WL
                        mint.
                ...
                {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
                  <div className="countDown">
                    <span className="when">
                      {" "}
                      The sale has ended. You can still find {
                        CONFIG.NFT_NAME
                      }{" "}
                      on<br></br>
                    </span>
                  ...
                  <div className="countDown">
                    ...
                    blockchain.smartContract === null ? (
                      <>
                        ...
                        {blockchain.errorMsg !== "" ? (
                          <p className="when"> {blockchain.errorMsg}</p>
                        ) : null}
                      </>
                    ) : (
                      <>
